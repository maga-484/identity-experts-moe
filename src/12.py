...
def generate_silo_data(seed, n_samples=500, input_dim=32, output_dim=32, variation=0.08):
...
# ------------------------------------------------------------
# Prueba con EWC (cambio pequeño variation=0.08)
# ------------------------------------------------------------
print("\n" + "="*60)
print("PRUEBA DE CAMBIO SUAVE CON EWC (variation 0.05 -> 0.08)")
print("="*60)
...
# Cambio pequeño: variation=0.08 (no 0.3)
X_new, y_new = generate_silo_data(seed=9999, n_samples=500, variation=0.08)
...
axes[0].set_title('Evolución con EWC (cambio pequeño)')
axes[0].legend()
axes[0].grid(True)
...
axes[1].set_title('Efecto de EWC (cambio pequeño)')
axes[1].legend()
axes[1].grid(True)
...
print("\n" + "="*60)
print("RESUMEN - 12.py CORREGIDO (EWC con cambio pequeño)")
print("="*60)
print(f"✓ Silos generados: {num_silos}")
print(f"✓ Expertos identitarios: {expert_wins}/10 victorias")
print(f"✓ Cambio: variation 0.05 → 0.08 (pequeño)")
